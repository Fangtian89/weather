...
//      https://api.caiyunapp.com/v2.5/ggepE823AvATQ6dj/121.6544,25.1552/daily.json
    ...
    @GET("/v2.5/${com.example.sunnyweatherkt.MyApplication.TOKEN}/{lng},{lat}/realtime.json")
    fun getRealTimeWeather(@Path("lng") lng:String, @Path("lat") lat:String): Call<RealTimeResponse>
    @GET("/v2.5/${com.example.sunnyweatherkt.MyApplication.TOKEN}/{lng},{lat}/daily.json")
